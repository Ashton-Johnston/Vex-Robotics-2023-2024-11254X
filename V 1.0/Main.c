...
// start of autononmous
    ...
    while (!((motor_get_position(FRONT_RIGHT_MOTOR) < dist1 + tolGreater) && (motor_get_position(FRONT_RIGHT_MOTOR) > dist1 + tolLesser))) {
    delay(2);
    }
    ...
    while(imu_get_rotation(IMU_PORT) > -90){
        motor_move(FRONT_RIGHT_MOTOR, 10);
        motor_move(BACK_RIGHT_MOTOR, 10);
        motor_move(FRONT_LEFT_MOTOR, -10);
        motor_move(BACK_LEFT_MOTOR, -10);
    } 
    if(imu_get_rotation(IMU_PORT) > -95 && imu_get_rotation(IMU_PORT) < -85){
    ...
    while (!((motor_get_position(FRONT_RIGHT_MOTOR) < dist3 + tolGreater) && (motor_get_position(FRONT_RIGHT_MOTOR) > dist3 + tolLesser))) {
    delay(2);
    }
    ...
    while (!((motor_get_position(FRONT_RIGHT_MOTOR) < dist6 + tolGreater) && (motor_get_position(FRONT_RIGHT_MOTOR) > dist6 + tolLesser))) {
    delay(2);
    }
    ...
    while (!((motor_get_position(FRONT_RIGHT_MOTOR) < dist7 + tolGreater) && (motor_get_position(FRONT_RIGHT_MOTOR) > dist7 + tolLesser))) {
    delay(2);
    }
    ...
    while (!((motor_get_position(FRONT_RIGHT_MOTOR) < 905) && (motor_get_position(FRONT_RIGHT_MOTOR) > 895))) {
    delay(2);
    }
